...
cat > expect << EOF
commit 268048bfb8a1fb38e703baceb8ab235421bf80c5 (master)
...
commit 1584215f1d29c65e99c6c6848626553fdd07fd75 (master)
Author: A U Thor <author@example.com>
...
printf "\n" >> expect-multiline
cat expect | sed -e s/master/master~1/ >> expect-multiline
...
commit 15023535574ded8b1a89052b32673f84cf9582b8 (master)
Author: A U Thor <author@example.com>
...
printf "\n" >> expect-m-and-F
cat expect-multiline | sed -e s/master~1/master~2/ -e 's/master)/master~1)/' \
    >> expect-m-and-F
